...
**M2 — Team-Ready CMS: 進行中** — Roles 完了、i18n 基盤が Up Next

193 tests / PHPStan Max / CS-Fixer / OpenAPI / MCP バリデーション — 全グリーン。
...
| 優先 | Issue | 項目 | 説明 |
| --- | --- | --- | --- |
| **P0** | [#109](https://github.com/hideyukiMORI/nene-records/issues/109) | Admin i18n 基盤 | 13 言語メッセージカタログ・`t()`・locale 切替 |
