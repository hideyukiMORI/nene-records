...
**M3 — P1 完了** — 全文検索 API（#131）・Admin UI リデザイン＋レスポンシブ（#128）・エクスポート API（#132 レビュー中）

225 tests / PHPStan Max / CS-Fixer / OpenAPI / MCP バリデーション — 全グリーン。
...
| P1 | Export API (CSV/JSON) | #130 | #132 | 🔄 レビュー中 |
| P2 | Draft preview token | #139 | #141 | 🔄 レビュー中 |
| P2 | Public cache / ETag | #142 | #143 | 🔄 レビュー中 |
| P2 | File field + upload | — | — | 📋 未着手 |
| P2 | Webhook / event hooks | — | — | 📋 未着手 |
...
```bash
composer check                    # 225 tests + PHPStan + CS-Fixer + OpenAPI + MCP
