...
export const ja = {
  ...
  'admin.themeWs.navFloatingCta': 'フローティングCTA',
  'admin.themeWs.descFloatingCta': '公開ページに常設するフローティングボタン。',
  'admin.floatingCta.intro':
    '公開ページに予約・問い合わせなどのフローティングボタンを表示します。サイト側が描画するので、どこでもスタイルが崩れません。',
  'admin.floatingCta.enabled': 'フローティングボタンを表示',
  ...
  'admin.floatingCta.urlUnsafe': 'このリンク形式は許可されていないため無視されます。',
  'admin.floatingCta.newTab': '新しいタブで開く',
  'admin.floatingCta.conditionsIntro': '表示する場所を絞れます（空欄なら全ページ）。',
  'admin.floatingCta.condTypes': '対象の型のみ',
  'admin.floatingCta.condUrls': '対象のパスのみ',
  'admin.floatingCta.condExclude': '除外するパス',
  'admin.floatingCta.save': '保存',
  'admin.floatingCta.saving': '保存中…',
  'admin.floatingCta.saved': 'フローティングCTAを保存しました。',
  'admin.floatingCta.saveError': 'フローティングCTAを保存できませんでした。',
