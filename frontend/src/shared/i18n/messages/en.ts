...
export const en = {
  ...
  'admin.themeWs.navFloatingCta': 'Floating CTA',
  'admin.themeWs.descFloatingCta': 'A floating action button shown on public pages.',
  'admin.floatingCta.intro':
    'Show a floating call-to-action button on public pages (e.g. booking or contact). The site renders it, so it stays styled everywhere.',
  'admin.floatingCta.enabled': 'Show floating button',
  ...
  'admin.floatingCta.urlUnsafe': 'This link scheme is not allowed and will be ignored.',
  'admin.floatingCta.newTab': 'Open in a new tab',
  'admin.floatingCta.conditionsIntro': 'Limit where it appears (leave empty to show everywhere).',
  'admin.floatingCta.condTypes': 'Only on types',
  'admin.floatingCta.condUrls': 'Only on paths',
  'admin.floatingCta.condExclude': 'Hide on paths',
  'admin.floatingCta.save': 'Save',
  'admin.floatingCta.saving': 'Saving…',
  'admin.floatingCta.saved': 'Floating CTA saved.',
  'admin.floatingCta.saveError': 'Could not save the floating CTA.',
