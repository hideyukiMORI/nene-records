...
export const en = {
  ...
  'admin.layoutCfg.hint': 'Column layout for record detail pages (the index is always 1 column).',
  ...
  'admin.navigation.location': 'Location',
  'admin.navigation.location.header': 'Header',
  'admin.navigation.location.footer': 'Footer',
  'admin.navigation.location.side': 'Side',
