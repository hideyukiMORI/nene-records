...
final class PreviewTokenHttpTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $publicSettings = new ListPublicSettingsUseCase(new InMemorySettingRepository(), new InMemoryMediaRepository(), new \NeNeRecords\PublicRecord\FrontPageSetting(new InMemorySettingRepository(), new InMemoryEntityRepository(), new InMemoryEntityTypeRepository()));
